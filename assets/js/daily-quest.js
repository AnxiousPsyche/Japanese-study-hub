...
const QUEST_POOL = [
    ...
    { lessonId: "s02c", title: "Reactions & Hedging Words", desc: "React naturally to what you hear." },
    { lessonId: "s02d", title: "Filler Words", desc: "Drop in a natural filler word." },
    { lessonId: "s03", title: "A は B です", desc: "Describe something with A は B です." },
    { lessonId: "s03b", title: "Basic Verbs & Word Order", desc: "Use a verb in a Subject-Object-Verb sentence." },
    { lessonId: "s04", title: "Self Introduction", desc: "Introduce yourself." },
    { lessonId: "s04b", title: "Self Introduction — Age & Hobby", desc: "Share your age or hobby." },
    { lessonId: "s05", title: "Demonstratives", desc: "Point out \"this\" or \"that\"." },
    { lessonId: "s06", title: "Questions (か)", desc: "Ask a yes/no question." },
    { lessonId: "s06d", title: "More Question Words", desc: "Ask who, when, why, or how many/much." },
    { lessonId: "s06b", title: "Existence Verbs", desc: "Say what does or doesn't exist." },
    { lessonId: "s06c", title: "Everyday Action Verbs", desc: "Use an everyday action verb politely." },
    ...
    { lessonId: "s07g", title: "Days, Dates in the Calendar", desc: "Say what day of the week it is, or a date." },
    ...
    { lessonId: "s10e", title: "Frequency Adverbs", desc: "Tell someone how often you do something." },
    { lessonId: "s10f", title: "Hardly Ever & Never", desc: "Say something almost never happens." },
